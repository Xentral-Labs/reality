...
- **FR-016c**: That part MUST contain only what a person sets, the state of the source and, when it is not producing, why. Counters, arrival times, monetary observations and the record of what arrived MUST NOT be repeated there; they belong to the views shared by every source.
