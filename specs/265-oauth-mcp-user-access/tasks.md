...
- [X] T009 [DR-002] [DR-004] [DR-005] Create additive migration `packages/reality-core/migrations/versions/0093_mcp_user_authorization.py`, including downgrade refusal after data exists and no change to business tables or `mcp_access_token`
...
- [ ] T058 Review migration `0093_mcp_user_authorization.py` through empty up/down/up, populated downgrade refusal, tenant-key catalog and rollback procedure; record evidence in `specs/265-oauth-mcp-user-access/quickstart.md`
