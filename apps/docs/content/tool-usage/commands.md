...
| `categories[].disposition`                             | `string`           | yes      | `evidenced`, `confirmed_zero`, `not_applicable`, `unresolved`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | —       |
...
| `selling_categories[].disposition`                     | `string`           | yes      | `evidenced`, `confirmed_zero`, `not_applicable`, `unresolved`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | —       |
...
| `positions[].selling_categories[].disposition`         | `string`           | yes      | `evidenced`, `confirmed_zero`, `not_applicable`, `unresolved`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | —       |
