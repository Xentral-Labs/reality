...
Die Beispiele nutzen einen Lieferanten, die Nordlicht Leuchten GmbH, einen Artikel, die
Schreibtischlampe LAMP-01, und kleine Mengen.
...
1. **Liste:** „Was müssen wir diese Woche kaufen?" → `item_supply_demand` · `fulfillment_blockers`
   LAMP-01 verfügbar 0, Bedarf 12, Zulauf 0, ungedeckt 12, 2 Aufträge blockiert · CABLE-2M ungedeckt
   40, 50 im Zulauf am 18.
...
1. **Sagen:** „Bestell 36 LAMP-01 bei Nordlicht zum Listenpreis, ins Hauptlager bis zum 18."
...
1. **Sehen:** „Was ist von Nordlicht fällig?" → PO-0210, 36 LAMP-01, fällig 18. → `commitments_list`
   · verspätete → `overdue_incoming_supplier_commitment`
2. **Sagen:** „36 LAMP-01 ins Hauptlager eingegangen." Karton beschädigt: „24 eingegangen, 12 gehen
   zurück."
...
1. **Sagen:** „Erfass Nordlichts ER-4471, 1.080,00, zu PO-0210, 36 zu 30,00."
...
1. **Vorschau:** „Zahllauf, Zahlung bis nächsten Freitag." → ER-4471 Nordlicht 1.080,00 fällig 20. ·
...
1. **Weniger, vereinbart:** „Wir haben 1.026,00 auf ER-4471 gezahlt; Nordlicht verzichtet auf 54,00,
...
2. **Zu viel:** „Wir haben versehentlich 1.180,00 auf ER-4471 gezahlt." → 1.080,00 zugeordnet,
   ...
   100,00 auf ER-4490" → Modus `allocate_credit` · oder „Nordlicht hat 100,00 erstattet" → Modus
   `refund_credit`
...
1. **Zurückschicken:** „12 beschädigte LAMP-01 sind zu PO-0210 an Nordlicht zurück." →
...
2. **Gutschrift erfassen:** „Erfass Nordlichts Gutschrift GS-N-118, 360,00, für die 12 Lampen." →
...
3. **Nutzen:** „Verrechne GS-N-118 mit ER-4471" → `supplier_credit_note_allocate_propose` · Geld
   zurück: „Nordlicht hat 360,00 erstattet, NL-2211" → `supplier_refund_post_propose`
