...
const dictionaries: Record<Exclude<Language, "en">, Record<string, string>> = {
  de: {
    ...
    "Keep testing": "Weiter testen",
    "{remaining} of 3 one-time extensions left":
      "{remaining} von 3 einmaligen Verlängerungen verfügbar",
    "Extra questions expire at the next daily reset.":
      "Zusätzliche Fragen verfallen beim nächsten täglichen Reset.",
    "Extension type": "Art der Freigabe",
    "Self-service extension": "Selbstverlängerung",
    "Admin grant": "Admin-Freigabe",
    "Extra questions": "Zusätzliche Fragen",
    "Add {count} test questions?": "{count} Testfragen hinzufügen?",
    "Get 20 more questions": "20 weitere Fragen freigeben",
    "Review grant": "Freigabe prüfen",
    "Extension history": "Freigabeverlauf",
    "No extensions yet.": "Noch keine Freigaben.",
    "Continued testing": "Weiteres Testen",
    ...
    "See open commitments, exceptions and decisions across your company.":
      "Sieh offene Commitments, Ausnahmen und Entscheidungen deiner Firma.",
    ...
    "Decision queue": "Entscheidungsübersicht",
  ...
  nl: {
    ...
    "Ledger entry": "Ledger Entry",
    "Business event": "Business Event",
    "Open exceptions": "Open uitzonderingen",
    "Decision queue": "Beslissingswachtrij",
    ...
    "Keep testing": "Verder testen",
    "{remaining} of 3 one-time extensions left": "Nog {remaining} van 3 eenmalige verlengingen",
    "Extra questions expire at the next daily reset.":
      "Extra vragen vervallen bij de volgende dagelijkse reset.",
    "Extension type": "Type verlenging",
    "Self-service extension": "Zelfbedieningsverlenging",
    "Admin grant": "Beheerderstoekenning",
    "Extra questions": "Extra vragen",
    "Add {count} test questions?": "{count} testvragen toevoegen?",
    "Get 20 more questions": "20 extra vragen krijgen",
    "Review grant": "Toekenning controleren",
    "Extension history": "Verlengingsgeschiedenis",
    "No extensions yet.": "Nog geen verlengingen.",
    "Continued testing": "Verder testen",
    ...
    "See open commitments, exceptions and decisions across your company.":
      "Bekijk open Commitments, uitzonderingen en beslissingen binnen je bedrijf.",
    "Track outstanding deliveries to your customers.":
    ...
    "Search exceptions": "Uitzonderingen doorzoeken",
  ...
  es: {
    ...
    "Ledger entry": "Ledger Entry",
    "Business event": "Business Event",
    "Open exceptions": "Incidencias pendientes",
    ...
    "Keep testing": "Seguir probando",
    "{remaining} of 3 one-time extensions left": "Quedan {remaining} de 3 ampliaciones únicas",
    "Extra questions expire at the next daily reset.":
      "Las preguntas adicionales caducan en el próximo reinicio diario.",
    "Extension type": "Tipo de ampliación",
    "Self-service extension": "Ampliación personal",
    "Admin grant": "Concesión del administrador",
    "Extra questions": "Preguntas adicionales",
    "Add {count} test questions?": "¿Añadir {count} preguntas de prueba?",
    "Get 20 more questions": "Obtener 20 preguntas más",
    "Review grant": "Revisar concesión",
    "Extension history": "Historial de ampliaciones",
    "No extensions yet.": "Todavía no hay ampliaciones.",
    "Continued testing": "Continuar las pruebas",
    ...
    "See open commitments, exceptions and decisions across your company.":
      "Consulta los Commitments, las incidencias y las decisiones pendientes de tu empresa.",
    "Track outstanding deliveries to your customers.":
    ...
    "Search exceptions": "Buscar incidencias",
    ...
    "All exceptions": "Todas las incidencias",
    You: "Tú",
    ...
    "No open exceptions.": "No hay incidencias pendientes.",
    ...
    "Obligations and exceptions": "Obligaciones y incidencias",
    "Obligations are unavailable. Refresh to retry.":
...
Object.assign(dictionaries.es, {
  ...
  "Projection or Exception": "Proyección o incidencia",
...
Object.assign(dictionaries.de, {
  ...
  "Operations / decision queue": "Betrieb / Entscheidungsübersicht",
...
Object.assign(dictionaries.nl, {
  ...
  "Operations / decision queue": "Bedrijfsvoering / beslissingswachtrij",
  ...
  "Source system": "Source-systeem",
  "Source systems": "Source-systemen",
...
Object.assign(dictionaries.es, {
  ...
  "Current exceptions": "Incidencias actuales",
  ...
  "Monitor the operating machine, isolate exceptions and trace each change to its source.":
    "Monitorizar la máquina de operación, aislar incidencias y rastrear cada cambio a su origen.",
  "Move from observation to recommendations only when you trust the result.":
  ...
  "One exception. One explainable resolution.": "Una incidencia. Una solución explicable.",
  "One operational core for facts, decisions and accountable automation.":
  ...
  "Review business events, processing activity and exceptions over time.":
    "Revisar eventos comerciales, actividad de procesamiento y incidencias a lo largo del tiempo.",
  "Review Business Events, processing history and exceptions.":
    "Revisar historial de eventos comerciales, actividad de procesamiento y incidencias.",
  "Review derived operational risks. They disappear when Reality is corrected.":
    "Revisar riesgos operativos derivados. Desaparecen cuando la Realidad se corrige.",
  "Review exceptions, commitments and current inventory.":
    "Revisar incidencias, compromisos e inventario actual.",
  ...
  "Source system": "Sistema Source",
  "Source systems": "Sistemas Source",
  ...
  "The Operations Cockpit turns connected records into a daily control surface — exceptions first, evidence one step away, agent responsibility always visible.":
    "El panel de control de operaciones convierte los registros conectados en una superficie de control diaria: primero las incidencias, la evidencia a un paso de distancia, la responsabilidad del agente siempre visible.",
  "The physical journal starts with the first receipt or opening stock.":
  ...
  "Thousands of events become a small number of clear exceptions that need attention.":
    "Miles de eventos se convierten en un pequeño número de incidencias claras que necesitan atención.",
...
Object.assign(dictionaries.de, {
  ...
  "Exception catalog": "Ausnahmekatalog",
  ...
  "Could not load the exception catalog.": "Der Ausnahmekatalog konnte nicht geladen werden.",
...
Object.assign(dictionaries.es, {
  ...
  "Exception catalog": "Catálogo de incidencias",
  ...
  "Could not load the exception catalog.": "No se pudo cargar el catálogo de incidencias.",
  "No matching exception classes.": "No hay clases de incidencia coincidentes.",
...
Object.assign(dictionaries.de, {
  ...
  "Source reference": "Source-Referenz",
...
Object.assign(dictionaries.nl, {
  ...
  "Source reference": "Source-referentie",
...
Object.assign(dictionaries.es, {
  ...
  "Source reference": "Referencia de Source",
...
Object.assign(dictionaries.de, {
  ...
  "Registered sources": "Registrierte Sources",
...
Object.assign(dictionaries.nl, {
  ...
  "Registered sources": "Geregistreerde Sources",
...
Object.assign(dictionaries.es, {
  ...
  "Registered sources": "Sources registradas",
...
Object.assign(dictionaries.es, {
  ...
  "All records": "Todos los registros",
  "Additional fact rules": "Reglas de Facts adicionales",
  "Exception rules": "Reglas de incidencias",
...
Object.assign(dictionaries.de, {
  ...
  "Open source": "Source Record öffnen",
...
Object.assign(dictionaries.nl, {
  ...
  "Open source": "Source Record openen",
...
Object.assign(dictionaries.es, {
  ...
  "Open source": "Abrir Source Record",
...
Object.assign(dictionaries.de, {
  ...
  "Select source system": "Source-System auswählen",
  ...
  "Refine the search to find more source systems.":
    "Suche eingrenzen, um weitere Source-Systeme zu finden.",
  ...
  "Source system not registered": "Source-System nicht registriert",
  "Source system blocked": "Source-System gesperrt",
...
Object.assign(dictionaries.nl, {
  ...
  "Select source system": "Source-systeem selecteren",
  ...
  "Refine the search to find more source systems.":
    "Verfijn de zoekopdracht om meer Source-systemen te vinden.",
  ...
  "Source system not registered": "Source-systeem niet geregistreerd",
  "Source system blocked": "Source-systeem geblokkeerd",
...
Object.assign(dictionaries.es, {
  ...
  "Select source system": "Seleccionar sistema Source",
  ...
  "Refine the search to find more source systems.":
    "Refina la búsqueda para encontrar más sistemas Source.",
  ...
  "Source system not registered": "Sistema Source no registrado",
  "Source system blocked": "Sistema Source bloqueado",
...
Object.assign(dictionaries.de, {
  ...
  "For commitment <opaque commitment ID>, use Reality MCP to prepare a reservation proposal for <quantity>. Do not approve or execute it. Return the proposal ID and explain the expected effect so a person can review it in Decisions.":
    "Bereite für das Commitment <opake Commitment-ID> mit Reality MCP einen Reservierungsvorschlag über <Menge> vor. Bestätige ihn nicht und führe ihn nicht aus. Gib die Vorschlags-ID zurück und erkläre die erwartete Wirkung, damit eine Person ihn unter Entscheidungen prüfen kann.",
...
Object.assign(dictionaries.nl, {
  ...
  "For commitment <opaque commitment ID>, use Reality MCP to prepare a reservation proposal for <quantity>. Do not approve or execute it. Return the proposal ID and explain the expected effect so a person can review it in Decisions.":
    "Gebruik Reality MCP om voor commitment <opaque commitment-ID> een reserveringsvoorstel voor <hoeveelheid> voor te bereiden. Keur het niet goed en voer het niet uit. Geef de voorstel-ID en het verwachte effect terug, zodat een persoon het in beslissingen kan beoordelen.",
  "Under the hood, an agent can use commitments_list or fulfillment_blockers to read, business_records_discover to resolve opaque records, and reservation_propose to prepare this example. Approval remains a separate human step.":
...
Object.assign(dictionaries.es, {
  ...
  "For commitment <opaque commitment ID>, use Reality MCP to prepare a reservation proposal for <quantity>. Do not approve or execute it. Return the proposal ID and explain the expected effect so a person can review it in Decisions.":
    "Para el compromiso <ID opaco del compromiso>, usa Reality MCP para preparar una propuesta de reserva por <cantidad>. No la apruebes ni ejecutes. Devuelve el ID de la propuesta y explica el efecto esperado para que una persona pueda revisarla en decisiones.",
  "Under the hood, an agent can use commitments_list or fulfillment_blockers to read, business_records_discover to resolve opaque records, and reservation_propose to prepare this example. Approval remains a separate human step.":
...
Object.assign(dictionaries.de, {
  ...
  "Open in Exceptions": "In Ausnahmen öffnen",
});
Object.assign(dictionaries.nl, {
...
Object.assign(dictionaries.es, {
  ...
  "Open in Exceptions": "Abrir en incidencias",
});
Object.assign(dictionaries.de, {
...
Object.assign(dictionaries.de, {
  ...
  "Show the original source": "Source Record anzeigen",
  "A newer source version exists": "Eine neuere Version des Source Records ist vorhanden",
  "Open in source system": "Im Source-System öffnen",
  "Several systems contributed to this record":
    "Mehrere Systeme haben zu diesem Datensatz beigetragen",
  "Address of the source system": "Adresse des Source-Systems",
  ...
  "Address of the source system saved.": "Adresse des Source-Systems gespeichert.",
  "Save address": "Adresse speichern",
  "Only the beginning of the original source is shown.":
    "Es wird nur der Anfang des Source Records angezeigt.",
});

Object.assign(dictionaries.nl, {
  "Created here": "Hier vastgelegd",
  "Show the original source": "Source Record bekijken",
  "A newer source version exists": "Er is een nieuwere versie van het Source Record",
  "Open in source system": "Openen in Source-systeem",
  "Several systems contributed to this record":
    "Meerdere systemen hebben aan dit record bijgedragen",
  "Address of the source system": "Adres van het Source-systeem",
  "Where this system's records can be opened, for example https://acme.myshopify.com/admin. Configuration only: the address is never called and holds no credentials.":
  ...
  "Address of the source system saved.": "Adres van het Source-systeem opgeslagen.",
  "Save address": "Adres opslaan",
  "Only the beginning of the original source is shown.":
    "Alleen het begin van het Source Record wordt getoond.",
});

Object.assign(dictionaries.es, {
  "Created here": "Registrado aquí",
  "Show the original source": "Ver Source Record",
  "A newer source version exists": "Existe una versión más reciente del Source Record",
  "Open in source system": "Abrir en el sistema Source",
  "Several systems contributed to this record": "Varios sistemas han contribuido a este registro",
  "Address of the source system": "Dirección del sistema Source",
  "Where this system's records can be opened, for example https://acme.myshopify.com/admin. Configuration only: the address is never called and holds no credentials.":
  ...
  "Address of the source system saved.": "Dirección del sistema Source guardada.",
