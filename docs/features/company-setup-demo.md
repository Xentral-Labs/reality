...
The canonical international-v9 profile contains 18 items, 20 customers, 3 suppliers, 2 locations, twenty-one operational sales cases, nine purchase cases and 84 days of historical evidence in two comparable 42-day windows. Beyond the standard order, return and settlement journeys it includes a price-only allowance, an exact invoice reversal, partial invoices, final underdelivery, warehouse transfer, damage/loss/scrap, lot expiry, serial receipt, exchange/replacement, prepayment, manual dunning with a stated fee, partial bad debt, customer and supplier deposit clearing, and controlled overdelivery.

Its bounded costing portfolio contains six complete source-backed contributions plus a late-cost/customer-return trade. Fixture A derives 40 remaining pcs valued at EUR 420 and 60 billed/fulfilled pcs cost-matched at EUR 630; EUR 1,200 net revenue yields DB1 of EUR 570 and EUR 90 direct plus EUR 24 allocated selling costs yield DB2 of EUR 456 (38%). Five additional exact cases cover healthy, low positive, negative, explicitly zero selling-cost and allocation-heavy DB2 outcomes. These are read-time observations, never stored as authority. Every payment, reversal, costing and commercial-edge decision goes through the same application services a person uses under the profile's narrow initialization authority. Continuous synthetic orders remain outside the reviewed portfolio and keep their default missing-cost semantics.
