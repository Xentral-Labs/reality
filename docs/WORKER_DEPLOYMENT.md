...
4. Scheduler command: `reality-scheduler work --poll-seconds 5`. Worker command: `reality-worker work --poll-seconds 5`. Initially one replica of each; multiple replicas must remain safe through database uniqueness/claims.
